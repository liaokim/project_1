                ...
                <form method="post" action="TravelDiaryServlet">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control " id="member_loginID" name="member_loginID" value="aa123">
...
<!--                                 <input type="text" class="form-control " id="TravelDiary_Name" name="TravelDiary_Name" > -->
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control " id="publish_date" name="publish_date" value="<%= new java.sql.Date(right.getTime())%>" >        
                            </div>
