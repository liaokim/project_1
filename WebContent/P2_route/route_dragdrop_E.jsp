...
<!-- ******************************************************************* -->
	...
	<select onchange="location.href=this.options[this.selectedIndex].value">
		<option value="route_dragdrop_N.jsp">北部</option>
  		...
  		<option value="route_dragdrop_S.jsp">南部</option>
  		<option value="route_dragdrop_E.jsp" selected>東部</option>
	</select>   
        ...
        (function ($) {      	
        	...
        	$.getJSON(url, {'area':area,'action':'GetAllByArea'}, function(datas){
        		$.each(datas,function(i,item){
            			...
            			var imgs = $('<img></img>').attr("src",'http://localhost:8081/bootstrap_test/GetImageServlet?id='+"E_"+ item.viewID + '_01')
            									   .addClass("viewimge")
